...
LOGGER = homework6.logging.get_logger("hw6-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = homework6.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = homework6.utils.file_summary(RECV_PATH)
